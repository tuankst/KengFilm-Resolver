// Story 10.12 — Motchill | Rail Group Korean v3
// Function: railGroupKorean()
// Fetches /quoc-gia/han-quoc → 1 rail: korean
// App calls this in parallel with other rail groups

async function railGroupKorean() {
...
// Target: https://motphimchillvl.org/quoc-gia/han-quoc?page=N

async function getAllKorean(page = 1) {
